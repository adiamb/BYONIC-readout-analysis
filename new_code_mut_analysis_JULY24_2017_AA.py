...
######################make a list of files  ( new chymotrypsin files added JULY24 2017) the new file suffix is *_CHYMO_JULY2017*
...
pan_chymo = ['AFLSA208A_PAN_CHYMO_JULY2017.csv', 'AFLSFDA280_PAN_CHYMO.csv', 'AFLSA174AA_PAN_CHYMO.csv', 'AFLSA096AA_PAN_CHYMO_JULY2017.csv','AFLSA097AA_PAN_CHYMO_JULY2017.csv','AFLSA167AB_PAN_CHYMO_JULY2017.csv']
...
for df in pan_chymo_dfs:
	...
	pan_chymo_DB.append(alldb)
	pan_chymo_checkids.append(allcheck)
...
for df in arp_tryp_dfs:
	...
	arp_chymo_DB.append(alldb)
	arp_chymo_checkids.append(allcheck)
